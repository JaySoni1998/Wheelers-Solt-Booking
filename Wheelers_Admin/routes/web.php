...
Route::get('/Delete_Staff/{E_ID}','StaffController@Delete_Staff')->name('Staff_DeleteData'); //Delete
Route::get('/Update_Staff/{E_ID}','StaffController@Update_Staff')->name('Staff_UpdateData'); //Update
...
//Plots and Slots
Route::get('/Add_Plots_&_Slots', function () {
    return view('Add_Plots_&_Slots');
});
